...
/*
8.	Розробити функцію, яка міняє місцями відповідні за номером 
елементи двох векторів цілих чисел однакової довжини. 
На основі розробленої функції переставити у зворотному порядку рядки 
введеної цілочисельної матриці. Надрукувати результуючу матрицю. 
*/
